...
object CurriesPAF extends App {
  ...
  // lifting - transform a method into a function
  // ETA-EXPANSION
  ...
  /*
    2. difference between
       ...
       - parameters : by-name vs 0-lambda (() => x)
  */
  ...
  */
  ...
  byName(method) // ok
  byName(parenMethod())
  // byName(parenMethod) // ok but beware (Not in Scala 3)
  // byName(() => 42) // not ok
  byName((() => 42)()) // ok
