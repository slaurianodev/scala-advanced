...
//  }
  ...
  println(BankingApp.purchase("Sergio", "iPhone15", "rock the jvm store", 3000))
  ...
  */
  ...
  // 4 - last out of the futures
  def last[A](fa: Future[A], fb: Future[A]): Future[A] = {
    // 1 promise which both both futures will try to complete
