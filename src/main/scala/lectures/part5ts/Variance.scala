...
//  class ContravariantCage[-T](val animal: T)
  ...
  */
  // class CovariantVariableCage[+T](var animal: T) // types of vars ar in CONTRAVARIANT POSITION
  /*
  ...
  // only acceptable type for variable
  class InvariantVariableCage[T](var animal: T) // ok

//  trait AnotherCovariantCage[+T] {
//    def addAnimal(animal: T) // COVARIANT POSITION
//  }

  class AnotherContravariaCage[-T] {
    def addAnimal(animal: T) = true
  }
  val acc: AnotherContravariaCage[Cat] = new AnotherContravariaCage[Animal]
  ...
  // val evilCat = shop.get(true, newCat)
